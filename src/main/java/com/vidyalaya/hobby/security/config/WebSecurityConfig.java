package com.vidyalaya.hobby.security.config;
...
public class WebSecurityConfig extends WebSecurityConfigurerAdapter {
	...
	public void configure(HttpSecurity http) throws Exception {
		http.csrf().disable().authorizeRequests()
				.antMatchers("/showReg", "/", "/index.html", "/registerUser", "/showLogin", "/login", "/logout","/reset_password","/handle_reset_password","/support")
				.permitAll()
